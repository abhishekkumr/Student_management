...
from work.models import Staff,Staff_Notification,Staff_Leave,Session_Year,Staff_Feedback,Subject,Student,Attendance,Attendance_report,StudentResult
from django.contrib import messages
from django.contrib.auth.decorators import login_required


# this is the function of home panel of staff
...
def TAKING_ATTENDANCE(request):
    ...
    return render(request,'staff/taking_attendance.html',context)
